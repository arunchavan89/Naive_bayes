...
int main() {
    vector< vector<double> > X_train = Load_State("./../states/train_states.txt");
    vector< vector<double> > X_test = Load_State("./../states/test_states.txt");
    vector< string > Y_train = Load_Label("./../states/train_labels.txt");
    vector< string > Y_test = Load_Label("./../states/test_labels.txt");

    cout << "X_train number of elements " << X_train.size() << endl;
    cout << "X_train element size " << X_train[0].size() << endl;
    cout << "Y_train number of elements " << Y_train.size() << endl;

    cout << "X_train  " << X_train[0][0] << endl;
    cout << "X_train  " << X_train[0][1] << endl;
    cout << "X_train  " << X_train[0][2] << endl;
    cout << "X_train  " << X_train[0][3] << endl;
    cout << "y_train  " << Y_train[0] << endl;
